...
export function registerStatusCommand(program: Command, getCtx: () => ArbContext): void {
	program
		...
		.option("-F, --fetch", "Fetch from all remotes before showing status (default)")
