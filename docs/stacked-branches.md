...
Run `arb rebase --retarget` to rebase onto the default branch and update the workspace config in one step:
...
arb rebase --retarget        # rebases feat/auth-ui onto main
